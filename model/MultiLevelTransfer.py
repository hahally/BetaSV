...
from model.repvgg import RepVGGStatsPool
...
class MLTmodel(nn.Module):
    def __init__(self,in_dim=768,hidden_dim=512,scale=8,bottleneck=128,embedding_size=192):
        ...
        self.head_model = UniSpeechSatModel.from_pretrained("../microsoft/")
        self.freeze_model()
        self.down_model = RepVGGStatsPool(in_planes=in_dim,embedding_size=embedding_size)
